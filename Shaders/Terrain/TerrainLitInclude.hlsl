...
half4 TextureSampleVirtual(Varyings IN)
{
    ...
    half3 albedo = _PhyscisAlbedo.Sample(Global_bilinear_clamp_sampler, uv).rgb;
    half3 normalTS = UnpackNormalScale(_PhyscisNormal.Sample(Global_bilinear_clamp_sampler, uv), 1);
    InputData inputData;
